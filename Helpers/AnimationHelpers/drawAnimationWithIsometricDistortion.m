function drawAnimationWithIsometricDistortion(meshname, trisurf_handle, numTimesPerInterval)
    info = getInformation(meshname);

    interpF = interpolateF(info, numTimesPerInterval);
    conformal_distortion = interpolateIsometricDistortion(info, numTimesPerInterval);
