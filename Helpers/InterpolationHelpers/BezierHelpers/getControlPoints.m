function control_points = getControlPoints(interpolated_points)
    ...
    num_points = size(interpolated_points, 2);
    ...
    intermediate_control_points = diag_matrix \ transpose(vector);
    control_points(:,2:end-1) = transpose( intermediate_control_points );
end